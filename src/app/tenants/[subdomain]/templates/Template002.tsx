...
export default function Template002({ tenant, subdomain }: Template002Props) {
  ...
  if (!tenant) {
    return (
      <div className="min-h-screen bg-[#f1f5f9] flex flex-col items-center justify-center text-[#334155] gap-4 font-sans p-6 text-center">
        ...
        <h2 className="text-lg font-bold text-teal-700">Pharmacy Website Not Found</h2>
  ...
  let services = [
    ...
    { title: 'Pediatric Care Solutions', description: 'Child-safe dosages, flavoring alternatives, and specialist infant wellness products.', icon: 'ShieldCheck' },
    { title: 'Over-the-Counter (OTC)', description: 'Wide range of quality OTC health supplements, skincare, and daily hygiene necessities.', icon: 'Sparkles' },
    { title: 'Immunization & Vaccines', description: 'Authorized standard seasonal flu vaccines and clinical travel vaccinations in-store.', icon: 'Activity' },
    { title: 'Cardiovascular Support', description: 'Blood pressure tracking devices, heart health guidance, and cholesterol management aid.', icon: 'Heart' },
    { title: 'General Wellness', description: 'Nutrition consultations, dietary planning, and custom vitamin subscription suggestions.', icon: 'Clock' }
  ];
  ...
  return (
    ...
    >
      ...
      <div className="text-white py-2 px-6 text-xs text-center font-semibold tracking-wide flex flex-wrap justify-center items-center gap-4 border-b border-white/10" style={{ backgroundColor: primaryColor }}>
        <div className="flex items-center gap-1.5">
          <Clock size={13} />
          <span>Hours: Mon - Fri {mondayOpen} - {mondayClose}</span>
        </div>
      ...
      <header className="bg-white sticky top-0 w-full z-50 border-b border-slate-200/80 shadow-sm transition-all duration-200">
        <div className="flex justify-between items-center w-full px-6 md:px-10 max-w-7xl mx-auto h-20">
          ...
          <div className="flex items-center gap-3 max-w-[65%] md:max-w-none">
            {tenant.logo_url ? (
              ...
              <div 
                ...
                style={{ backgroundColor: primaryColor, width: `${logoHeight + 6}px`, height: `${logoHeight + 6}px` }}
              >
                PH
              </div>
            )}
          ...
          <div className="hidden md:flex items-center gap-8 text-sm font-semibold text-slate-600">
            <a className="hover:text-teal-700 transition-colors" href="#">Home</a>
            <a className="hover:text-teal-700 transition-colors" href="#about">About Us</a>
            <a className="hover:text-teal-700 transition-colors" href="#services">Services</a>
            <a className="hover:text-teal-700 transition-colors" href="#stock">Stock Search</a>
            <a className="hover:text-teal-700 transition-colors" href="#details">Location</a>
          </div>
        ...
        {mobileMenuOpen && (
          <div className="md:hidden border-t border-slate-200 bg-white px-6 py-4 space-y-3 shadow-md">
            <a className="block text-sm font-semibold text-slate-600 py-1" href="#" onClick={() => setMobileMenuOpen(false)}>Home</a>
            <a className="block text-sm font-semibold text-slate-600 py-1" href="#about" onClick={() => setMobileMenuOpen(false)}>About Us</a>
            <a className="block text-sm font-semibold text-slate-600 py-1" href="#services" onClick={() => setMobileMenuOpen(false)}>Services</a>
            <a className="block text-sm font-semibold text-slate-600 py-1" href="#stock" onClick={() => setMobileMenuOpen(false)}>Stock Search</a>
            <a className="block text-sm font-semibold text-slate-600 py-1" href="#details" onClick={() => setMobileMenuOpen(false)}>Location</a>
          </div>
        )}
      </header>
      ...
      <main>
        ...
        <section className="relative min-h-[70vh] flex items-center bg-teal-800 text-white overflow-hidden" style={{ backgroundColor: primaryColor }}>
              ...
              <div className="hidden md:col-span-5 md:flex justify-center">
                <div className="bg-white p-8 rounded-2xl shadow-xl border border-slate-100 text-slate-800 max-w-sm space-y-4">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <h3 className="font-bold text-sm">Professional Pharmacy Care</h3>
                      <p className="text-[11px] text-slate-500">Expert care you can count on.</p>
                    </div>
                  </div>
                  <hr className="border-slate-100" />
                  <p className="text-xs text-slate-600 leading-relaxed">
                    Upload your prescriptions directly, query stock availability, and receive licensed counselor guidance.
                  </p>
                  <div className="flex justify-between items-center text-xs font-semibold text-teal-700 bg-teal-50/50 p-2.5 rounded-lg">
                    <span>Emergency Hotline:</span>
                    <span className="font-bold">{tenant.contact_phone || 'N/A'}</span>
                  </div>
                </div>
              </div>
          ...
          <div className="max-w-7xl mx-auto">
            <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 py-8 px-6 bg-white rounded-xl shadow-md border border-slate-200/60">
              ...
              <div className="text-center px-4 border-r border-slate-100 last:border-0">
                <div className="text-3xl font-extrabold text-teal-700 mb-1" style={{ color: primaryColor }}>
                  {statExperience}
                </div>
                <div className="text-[11px] font-bold text-slate-500 uppercase tracking-wider">Years Experience</div>
              </div>
              ...
              <div className="text-center px-4 lg:border-r border-slate-100 last:border-0">
                ...
                <div className="text-[11px] font-bold text-slate-500 uppercase tracking-wider">Satisfaction Rate</div>
              </div>
              ...
              <div className="text-center px-4 border-r border-slate-100 last:border-0">
                ...
                <div className="text-[11px] font-bold text-slate-500 uppercase tracking-wider">Prescriptions Filled</div>
              </div>
              ...
              <div className="text-center px-4">
                ...
                <div className="text-[11px] font-bold text-slate-500 uppercase tracking-wider">Licensed Staff</div>
              </div>
        ...
        <section id="about" className="py-16 md:py-24 bg-white px-6">
          <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-12 md:gap-16 items-center">
            ...
            <div className="relative">
              ...
              <div className="absolute -bottom-6 -right-6 bg-slate-900 text-white p-5 rounded-xl shadow-lg border border-slate-800 max-w-[220px] text-left">
                <div className="flex items-center gap-2 mb-1.5 text-teal-400">
                  <ShieldCheck size={24} />
                  <span className="font-bold text-xs uppercase tracking-wider">Verified Care</span>
                </div>
                <div className="font-semibold text-xs text-slate-200 leading-tight">Ministry Registered Pharmacy</div>
                <div className="text-[10px] text-slate-400 mt-2 font-mono">Reg: {tenant.display_slmc_number || 'SLMC-PH-8921'}</div>
              </div>
            </div>
            ...
            <div className="text-left space-y-6">
              <div>
                <div className="text-xs font-bold uppercase tracking-widest mb-2 text-teal-600" style={{ color: secondaryColor }}>
                  About Our Pharmacy
                </div>
                <h2 
              ...
              <p className="text-sm md:text-base text-slate-600 leading-relaxed">
                At {tenant.name}, we are committed to providing the highest quality pharmaceutical care. We stock only registered and verified medications, verified by the National Medicines Regulatory Authority (NMRA).
              </p>
              
              <p className="text-sm md:text-base text-slate-600 leading-relaxed">
                Our in-house pharmacists offer prescription analysis, drug interaction checks, and individual patient consultations to ensure the safety and success of your wellness plan.
              </p>

              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 pt-2">
                <div className="flex items-start gap-2.5">
                  <CheckCircle size={16} className="text-teal-600 shrink-0 mt-0.5" />
                  <span className="text-xs font-semibold text-slate-700">100% Genuine Brands</span>
                </div>
                <div className="flex items-start gap-2.5">
                  <CheckCircle size={16} className="text-teal-600 shrink-0 mt-0.5" />
                  <span className="text-xs font-semibold text-slate-700">Experienced Pharmacists</span>
                </div>
                <div className="flex items-start gap-2.5">
                  <CheckCircle size={16} className="text-teal-600 shrink-0 mt-0.5" />
                  <span className="text-xs font-semibold text-slate-700">Cold Chain Storage</span>
                </div>
                <div className="flex items-start gap-2.5">
                  <CheckCircle size={16} className="text-teal-600 shrink-0 mt-0.5" />
                  <span className="text-xs font-semibold text-slate-700">Detailed Instructions</span>
                </div>
              </div>
        ...
        <section id="stock" className="py-16 md:py-24 bg-slate-100 border-t border-b border-slate-200/80 px-6">
          <div className="max-w-7xl mx-auto text-left space-y-8">
            <div className="text-center md:text-left">
              ...
              <p className="text-xs text-slate-500 mt-1 max-w-xl">
                Check medicine availability in our store registry instantly. Prices and quantities are updated in real-time.
              </p>
            </div>
            ...
            <div className="bg-white border border-slate-200/80 rounded-2xl overflow-hidden shadow-sm">
              {loadingInventory ? (
                <div className="py-20 flex flex-col items-center justify-center gap-3">
                  ...
                  <span className="text-xs font-semibold text-slate-500">Checking inventory registry...</span>
                </div>
              ) : filteredMedicines.length === 0 ? (
                <div className="py-16 text-center text-slate-400 space-y-2">
                  <Info className="h-8 w-8 mx-auto text-slate-300" />
                  <p className="text-sm font-semibold">No in-stock medicines found matching search</p>
                  <p className="text-xs max-w-sm mx-auto">Please try searching with another spelling or contact our counter via WhatsApp for manual checking.</p>
                </div>
              ) : (
            ...
            <div className="flex gap-2 items-center bg-teal-50 border border-teal-100/60 p-4 rounded-xl text-teal-800 text-xs">
              ...
              <span>Can't find a medicine? Sourced imports can be arranged. Contact our pharmacists via WhatsApp to request special imports.</span>
            </div>
          </div>
        </section>
          ...
          <div className="max-w-7xl mx-auto text-left space-y-12">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
              {services.map((svc, idx) => (
                <div key={idx} className="bg-white rounded-xl p-6 border border-slate-200/80 hover:border-slate-300 transition-colors shadow-sm flex flex-col justify-between space-y-4">
                  <div className="space-y-4">
                    ...
                    <h3 className="font-bold text-sm text-slate-900 font-display">{svc.title}</h3>
        ...
        <section id="details" className="py-16 md:py-24 bg-slate-50 border-t border-slate-200/80 px-6">
          <div className="max-w-7xl mx-auto text-left space-y-12">
            <div>
              <div className="text-xs font-bold uppercase tracking-widest mb-2 text-teal-600" style={{ color: secondaryColor }}>
                Store Visit Details
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
              ...
              <div className="lg:col-span-5 bg-white border border-slate-200/80 rounded-xl p-6 shadow-sm space-y-4">
                <h3 className="font-bold text-xs uppercase tracking-wider text-slate-400">Regular Store Hours</h3>
                
                <div className="flex justify-between items-center py-2 border-b border-slate-100">
                  <span className="font-semibold text-xs text-slate-700">Monday - Friday</span>
                ...
                <div className="flex justify-between items-center py-2 border-b border-slate-100 bg-slate-50 -mx-6 px-6">
                  <div className="flex items-center gap-2">
                    <span className="font-bold text-xs text-slate-950">Today</span>
                    {isOpenNow ? (
                      <span className="bg-emerald-100 text-emerald-800 font-extrabold text-[8px] px-2 py-0.5 rounded-full uppercase tracking-wider">Open Now</span>
                    ) : (
                  ...
                  <span className="text-xs font-bold text-teal-700 font-mono" style={{ color: primaryColor }}>{mondayOpen} - {mondayClose}</span>
                </div>

                <div className="flex justify-between items-center py-2 border-b border-slate-100">
                  <span className="font-semibold text-xs text-slate-700">Saturday</span>
                  <span className="text-xs text-slate-600 font-mono">09:00 AM - 07:00 PM</span>
                </div>

                <div className="flex justify-between items-center py-2">
                  <span className="font-semibold text-xs text-slate-700">Sunday</span>
                ...
                {autoCloseHolidays && (
                  <div className="pt-4 border-t border-slate-100 text-[10px] text-slate-500 flex gap-2 items-start leading-relaxed">
                    ...
                    <span>
                      Store is closed on Sri Lankan public holidays and religious holidays 
              ...
              <div className="lg:col-span-7 bg-white border border-slate-200/80 rounded-xl overflow-hidden shadow-sm">
                ...
                <div className="p-5 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                  <div className="text-left space-y-1">
                    <p className="font-bold text-xs text-slate-900">{tenant.contact_address || 'No store address configured.'}</p>
                    <p className="text-[10px] text-slate-500">Colombo, Sri Lanka</p>
                  </div>
                  <button 
                    onClick={handleGetDirections}
      ...
      <footer className="w-full bg-slate-900 text-slate-400 py-16 px-6 md:px-10 border-t border-slate-800">
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-12 gap-8 text-left">
          ...
          <div className="md:col-span-6 space-y-4">
            <h2 className="text-white text-lg font-bold font-display">{tenant.name}</h2>
            <p className="text-xs text-slate-400 max-w-sm leading-relaxed">
              Your registered digital community pharmacy providing licensed medical products and care consultation.
            </p>
            ...
            <div className="text-[10px] text-slate-500 pt-2">
              &copy; {new Date().getFullYear()} {tenant.name}. Powered by <a href="https://quantumblaze.lk" target="_blank" rel="noopener noreferrer" className="font-semibold text-white hover:underline">Quantum Blaze</a>.
            </div>
          </div>

          <div className="md:col-span-3 flex flex-col gap-2.5 text-xs text-slate-400">
            <h4 className="font-bold text-white mb-1 uppercase tracking-wider text-[10px]">E-Care Services</h4>
            <a className="hover:text-white" href="#stock">In-Stock Search</a>
            <a className="hover:text-white" href="#">Prescription Upload</a>
            <a className="hover:text-white" href="#">Consultation Booking</a>
          </div>

          <div className="md:col-span-3 flex flex-col gap-2.5 text-xs text-slate-400">
            <h4 className="font-bold text-white mb-1 uppercase tracking-wider text-[10px]">Compliance &amp; Legal</h4>
            <a className="hover:text-white" href="#">Privacy Policy</a>
            <a className="hover:text-white" href="#">Terms &amp; Conditions</a>
            <a className="hover:text-white" href="#">Safety Regulations</a>
          </div>
          ...
          <div className="bg-white border border-slate-200 rounded-2xl p-6 md:p-8 max-w-lg w-full shadow-2xl relative animate-in zoom-in-95 duration-200 text-left">
            ...
            <div className="space-y-4 max-h-[60vh] overflow-y-auto pr-1">
              ...
              {certificates.map((cert, idx) => (
                <div key={idx} className="border border-slate-200 rounded-xl p-3 bg-slate-50 flex flex-col items-center">
                  <span className="text-xs font-bold text-slate-800 self-start mb-2">{cert.name}</span>
                  <img src={cert.url} alt={cert.name} className="max-h-64 object-contain rounded-lg border border-slate-200 shadow-sm" onError={(e) => { (e.target as HTMLImageElement).src = 'https://images.unsplash.com/photo-1586015555751-63bb77f4322a?auto=format&fit=crop&w=400&q=80'; }} />
                </div>
              ))}
            </div>
